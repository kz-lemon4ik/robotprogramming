...
bool IKCalculator::calculate_joint_angles(double target_x, double target_y, double& theta1,
                                          double& theta2) const {
...
bool IKCalculator::handle_origin_singularity(double target_x, double target_y, double& theta1,
                                             double& theta2) const {
  const double distance = calculate_distance(target_x, target_y);
...
bool IKCalculator::handle_boundary_cases(double target_x, double target_y, double& theta1,
                                         double& theta2) const {
  const double distance = calculate_distance(target_x, target_y);
  const double max_reach = get_max_reach();
  const double min_reach = get_min_reach();
