...
class IKCalculator {
 public:
  ...
  bool calculate_joint_angles(double target_x, double target_y, double& theta1,
                              double& theta2) const;
  ...
  // Get link lengths
  double get_link1_length() const {
    return L1_;
  }
  double get_link2_length() const {
    return L2_;
  }
 ...
 private:
  ...
  bool handle_origin_singularity(double target_x, double target_y, double& theta1,
                                 double& theta2) const;
  bool handle_boundary_cases(double target_x, double target_y, double& theta1,
                             double& theta2) const;
};
